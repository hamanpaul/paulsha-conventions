# preflight-ci skill ownership tasks

## 1. Canonical ownership

- [x] 1.1 Add the skill, wrapper, references, and safe installer.
- [x] 1.2 Add verified source-engine resolution without Actions workflow lookup.
- [x] 1.3 Require repo-owned steps for full skill mode.
