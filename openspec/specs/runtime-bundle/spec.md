# runtime-bundle Specification

## Purpose
定義 policy engine、完整 wheel dependency closure 與 `preflight-ci` skill 的不可變
版本化交付單元，以及可驗證的 offline install、exact-version selection、
activation、rollback 與 uninstall 契約。
## Requirements
