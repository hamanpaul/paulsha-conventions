...
|----------------|-----------|------------|------|
| 1.0.13 | `v1.0.13` | `840d8945e80d8322b4cf0f04d40bb9d995522c16` | #42 修正 release ledger tag SHA 與自我檢測；#45 將 R-21 改為 visibility-aware 並擴充 credential detectors／減敏輸出；#46 建立 canonical local CI-parity `preflight-ci` skill、pinned/source/offline engine 驗證與 fail-closed gate orchestration |
