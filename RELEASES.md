...
|----------------|-----------|------------|------|
| 1.0.14 | `v1.0.14` | `56da1f77aa677ba9942f485dff964147682fe7c5` | #48 建立 clean-tag versioned runtime bundle、exact-version selector、offline install/activate/rollback、installed wheel/venv identity attestation，並將 `.project-policy.yml` 升格為 canonical public manifest；公司 artifact authority 仍由 #39 決策 |
