...
def _make_smoke_repo(root: Path, version: str) -> tuple[Path, Path]:
    ...
    config = (
        ...
        "  mode: pip\n"
        "secret_scan:\n"
        "  # Synthetic fixture argv must embed an absolute interpreter path for minimal-env runs;\n"
        "  # that path is not a secret and is a legitimate R-21 allowlisted reference.\n"
        "  allow:\n"
        "    - .project-policy.yml\n"
        "preflight:\n"
        "  steps:\n"
