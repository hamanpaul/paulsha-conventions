...
- [R-21 visibility coupling（#45）](../openspec/changes/r21-visibility-coupling/proposal.md) — candidate 已實作並整合，待 batch archive
- [canonical local preflight（#46）](../openspec/changes/canonical-local-preflight/proposal.md) — candidate 已實作、對抗審查通過，待 batch archive
...
- [R-21 visibility coupling（#45）](superpowers/plans/2026-07-26-issue-45-r21-visibility-coupling.md) — 已實作、對抗審查通過並整合
- [canonical local preflight（#46）](superpowers/plans/2026-07-26-issue-46-local-preflight.md) — 已實作、對抗審查通過並驗收
