...
- [canonical local preflight（#46）](../openspec/changes/canonical-local-preflight/proposal.md) — candidate 實作與驗收中
...
- [canonical local preflight（#46）](superpowers/plans/2026-07-26-issue-46-local-preflight.md) — 實作與驗收中
