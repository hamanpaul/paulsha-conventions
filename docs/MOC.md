...
- [changelog-fragments（#24）](superpowers/plans/2026-06-30-changelog-fragments.md) — 本批落地（per-PR fragment / R-04 / R-09 / collate）
...
- [changelog-fragments design（#24）](superpowers/specs/2026-06-30-changelog-fragments-design.md) — 本批落地（per-PR fragment / R-04 / R-09 / collate）
